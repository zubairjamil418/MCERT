...
export const generateMCLERTSReport = async (formData) => {
  const data = {
    ...
    // Flow Meter Verification (Section 3.3)
    ...
    verificationCurvePointCheck: formData.verificationCurvePointCheck || "",
    ...
    nextFlowValidationDate: formatDateToDDMMYYYY(
      formData.nextFlowValidationDate
    ),
