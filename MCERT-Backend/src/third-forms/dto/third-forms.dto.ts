...
export class McertsFormDataDto {
  ...
  thirdaryDeviceImages?: FileUploadDto[];
...
// Create Form DTO
export class CreatethirdFormDto {
...
// Update Form DTO
export class UpdatethirdFormDto {
...
export class thirdFormSubmissionDto {
  formData: McertsFormDataDto;
  status?: string;
  userId?: string;
}
...
// Form Response DTO
export class thirdFormResponseDto {
  _id: Types.ObjectId;
...
export class PaginatedthirdFormsDto {
  data: any[];
...
export class thirdFormQueryDto {
  page?: number = 1;
  limit?: number = 5;
...
export class thirdFormCreationResponseDto {
  success: boolean;
  data?: any;
  message?: string;
  error?: string;
...
// Bulk Update DTO
export class BulkUpdatethirdFormDto {
...
// Bulk Delete DTO
export class BulkDeletethirdFormDto {
  formIds: Types.ObjectId[];
}
